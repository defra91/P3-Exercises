...
public class Ball extends Ellipse2D.Double implements Runnable {	
	...
	/** Imposta la velocità iniziale orizzontale della pallina espressa in metri al secondo.
	 * @param d Velocità x della pallina espressa in metri al secondo.
	 */
	void setVelX(double d) { velX = d; }
	
	/** Imposta la velocità iniziale verticale della pallina espressa in metri al secondo.
	...
	/** Restituisce la velocità x della pallina in metri al secondo.
	 * @return velocità x.
	 */
	double getVelX() { return velX; }
	
	/** Restituisce la velocità y della pallina in metri al secondo.
	 * @return velocità y.
	 */
